...
```{r compare-limno-CB, dpi = 500, warning = FALSE, fig.width = 10, fig.height = 8}
...
```{r ani-analysis, dpi = 500, fig.width = 8, fig.height = 9, warning = FALSE}
# read file
# data.ANI <- read.table("./ANI/ANIb_percentage_identity.tab")
data.ANI <- read.table("./ANI/ANIb_wRhodo_percentage_identity.tab")
...
ord_list_bin <- c("Lim sp. Rim11","Lim. sp. 103DPR2",
                  ...
                  "Rhodo. ferrireducens T118",
                  "Rhodo. saidenbachensis ED16")
