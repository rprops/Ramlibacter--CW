...
```{r panG-analysis, dpi = 500, fig.width = 13, fig.height = 10, warning = FALSE, dev = c("png","pdf")}
...
```{r panG-analysis-2, dpi = 500, fig.width = 6, fig.height = 4.5, warning = FALSE, dev = c("png","pdf")}
...
### Statistics
```{r panG-analysis-3, dpi = 500, fig.width = 6, fig.height = 4.5, warning = FALSE, dev = c("png","pdf")}
...
```{r size-1, warning = FALSE, fig.width = 2.5, fig.height = 5, dpi = 500, dev = c("png", "pdf")}
...
# Calculate median
Raquat_size %>% summarize(median(Length))
# Calculate standard deviation
Raquat_size %>% summarize(sd(Length))
```
