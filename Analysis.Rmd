...
```{r OTU1-dynamics, warning = FALSE, dpi = 500, fig.width = 9, fig.height = 5.5, dev = c("png", "svg")}
...
```{r Transp-1, warning = FALSE, fig.width = 7, fig.height = 7, dpi = 500}
...
### Heatmap
```{r Transp-3, warning = FALSE, fig.width = 15, fig.height = 3.5, dpi = 500, dev = c("png", "pdf")}
...
```{r Pho-1, warning = FALSE, fig.width = 8.5, fig.height = 6, dpi = 500, dev = c("png", "pdf")}
