...
{"columns":[{"label":["Genome"],"name":[1],"type":["chr"],"align":["left"]},{"label":["CAZY_counts"],"name":[2],"type":["int"],"align":["right"]}],"data":[{"1":"Bacteroidetes sp. MAG1","2":"249"},{"1":"Bacteroidetes sp. MAG2","2":"293"},{"1":"Ramlibacter sp. MAG","2":"108"}],"options":{"columns":{"min":{},"max":[10]},"rows":{"min":[10],"max":[10]},"pages":{}}}
  </script>
</div>
