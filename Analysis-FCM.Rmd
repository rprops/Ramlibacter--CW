...
counts %>% group_by(NutrientCondition) %>% 
  summarize(cor_p_value= cor.test(HNA.cells, Total.cells)$p.value,
            cor_counts= cor.test(HNA.cells, Total.cells)$estimate)
...
counts %>% group_by(NutrientCondition) %>% 
  summarize(cor_p_value= cor.test(LNA.cells, Total.cells)$p.value,
            cor_counts= cor.test(LNA.cells, Total.cells)$estimate)

counts %>% group_by(NutrientCondition) %>% 
  summarize(cor_p_value= cor.test(LNA.cells, HNA.cells)$p.value,
            cor_counts= cor.test(LNA.cells, HNA.cells)$estimate)
```
